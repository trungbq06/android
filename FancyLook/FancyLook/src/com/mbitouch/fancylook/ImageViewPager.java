...
public class ImageViewPager extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pager.setAdapter(new ImagePagerAdapter(arrImage));
...
//		mAttacher.cleanup();
	...
	private class ImagePagerAdapter extends PagerAdapter {
		...
		ImagePagerAdapter(ArrayList<Image> arrImage) {
...
//			mAttacher.setOnPhotoTapListener(new PhotoTapListener());
			...
			imageLoader.displayImage(arrImage.get(position).getUrlImage(), imageView, options, new SimpleImageLoadingListener() {
				@Override
				...
				public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
					...
					Toast.makeText(ImageViewPager.this, message, Toast.LENGTH_SHORT).show();
