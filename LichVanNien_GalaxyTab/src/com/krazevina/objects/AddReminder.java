...
public class AddReminder extends PopupWindow implements OnClickListener, OnTouchListener
{
	Button btnclose,btnadd,btnalarmtone,btnalarmstyle,btnrepeatstyle;
	...
	int oldsetting = 0,alarmtoneindex = 0;
	boolean extend = false;
	
	int alarmstyle = 0,repeatstyle = 0;
	...
	public AddReminder(View v,int w,int h, boolean focus,Calendar cal) 
	{
		super(v,w,h,focus);
