...
public final class HorizontalPaper extends ViewGroup {
    /*
    ...
    private static final int FRACTION_OF_SCREEN_WIDTH_FOR_SWIPE = 3;
     ...
     */
    public HorizontalPaper(final Context context) {
        super(context);
        init();
    }
     ...
     */
    public HorizontalPaper(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setCurrentScreen(final int currentScreen, final boolean animate) {
        ...
        invalidate();
//        this.mOnScreenSwitchListener.onScreenSwitched(currentScreen);
//        invalidate();
    }
